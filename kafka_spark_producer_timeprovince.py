...
FILE_PATH = "/Users/Adithya/Desktop/iNeuron/Spark/Assignment/TimeProvince.csv"
...
def timep_to_dict(order: Order, ctx):
    """
...
def main(topic):
  ...
  "type": "object"
    ...
    schema_str = schema_registry_client.get_latest_version('topic_timeprovince-1-value').schema.schema_str

    string_serializer = StringSerializer('utf_8')
    json_serializer = JSONSerializer(schema_str, schema_registry_client, timep_to_dict)
    ...
    try:
        for order in get_order_instance(file_path=FILE_PATH):
            ...
            producer.produce(topic=topic,
                             key=string_serializer(str(uuid4()), timep_to_dict),
